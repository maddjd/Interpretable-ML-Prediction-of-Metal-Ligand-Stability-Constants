...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "IUPAC_v2_Stacking__")
...
BEST_GBR_PARAMS = {
    "n_estimators": 850,
    "learning_rate": 0.035066859556091366,
    "max_depth": 5,
    "min_samples_split": 19,
    "min_samples_leaf": 2,
    "subsample": 0.7853532530087978,
    "max_features": 0.9243742305707868,
    "loss": "squared_error",
}

BEST_RIDGE_ALPHA = 46.4085960495

#  Optuna  R²，
BEST_RF_CV_R2 = 0.955497
BEST_GBR_CV_R2 = 0.963566
BEST_RIDGE_CV_R2 = 0.963467
